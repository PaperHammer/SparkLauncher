...
using Downloader;
using SparkLauncher.Common.Interfaces;
using IDownload = SparkLauncher.Common.Interfaces.IDownload;

namespace SparkLauncher.Common.Utils.Download {
    public class MultiDownloadService : IDownload {
